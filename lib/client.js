		...
		*/
		function SidebarBalanceCard({ wide, t, useSessions }) {
			...
			*/
			...
			/** Anchor the panel just above the card, inside the viewport. */
			const placePopover = () => {
				const el = wrapRef.current;
				if (el === null) return;
				const rect = el.getBoundingClientRect();
				// PANEL_MIN_WIDTH keeps the 240px panel from running off the right
				// edge when the sidebar sits far right on a narrow window.
				const PANEL_MIN_WIDTH = 248;
				setPopPos({
					left: Math.max(8, Math.min(Math.round(rect.left), window.innerWidth - PANEL_MIN_WIDTH)),
					...
					children: [(0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
							children: [(0, react_jsx_runtime.jsx)("div", {
								...
								children: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
									children: [(0, react_jsx_runtime.jsx)("span", { className: "dshbw_ico",
										children: (0, react_jsx_runtime.jsx)("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.7, strokeLinecap: "round", strokeLinejoin: "round", children: [(0, react_jsx_runtime.jsx)("rect", { x: 3, y: 6, width: 18, height: 13, rx: 2 }), (0, react_jsx_runtime.jsx)("path", { d: "M3 10h18" })] })
